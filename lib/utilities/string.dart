class Constant {
  ...
  static String terms4=  "The Salon is responsible for managing appointments and providing customer service to customers who book appointments through the VYLEE Salon website.";
  static String terms5=  "In case of any disputes between the Salon and customers, VYLEE Salon will mediate and work towards a resolution satisfactory to both parties. This agreement is subject to jurisdiction of Panipat.";
  static String terms6=  "VYLEE Salon will promote the Salon’s services through its website and marketing channels to enhance the Salon’s visibility and sales.";
  static String terms7=  "Either party may terminate this agreement by providing written notice to the other party. Upon termination, VYLEE Salon will remove the Salon from its platform.";
  static String terms8=  "VYLEE Salon shall not be held liable for any legal issues arising from services provided by the Salon. VYLEE Salon takes responsibility for prepaid payments made by customers.";
  static String terms9=  "Any confidential information shared by the Salon with VYLEE Salon shall be protected and kept confidential.";
  static String terms10=  "The Salon agrees to maintain high-quality services to ensure customer satisfaction.";
  static String terms11=  "Salon has access on VYLEE partner app to manage their pricing and offers.";
